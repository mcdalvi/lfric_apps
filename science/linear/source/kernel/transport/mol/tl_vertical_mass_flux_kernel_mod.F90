...
!> @brief Kernel which computes tangent linear vertical mass flux using an
!!        upwind reconstruction of a field on cell edges.
!!        The upwind direction is dictated by the linear wind
module tl_vertical_mass_flux_kernel_mod
...
type, public, extends(kernel_type) :: tl_vertical_mass_flux_kernel_type
  private
...
contains
  procedure, nopass :: tl_vertical_mass_flux_code
end type

!-------------------------------------------------------------------------------
! Contained functions/subroutines
!-------------------------------------------------------------------------------
public :: tl_vertical_mass_flux_code
...
subroutine tl_vertical_mass_flux_code( nlayers,                &
                                       mass_flux,              &
                                       ls_wind,                &
                                       wind,                   &
                                       reconstruction,         &
...
end subroutine tl_vertical_mass_flux_code

end module tl_vertical_mass_flux_kernel_mod
