...
module transport_enumerated_types_mod
  ...
  integer(kind=i_def), parameter :: monotone_strict   = 4_i_def
  integer(kind=i_def), parameter :: monotone_relaxed  = 5_i_def
  integer(kind=i_def), parameter :: monotone_positive = 6_i_def
  integer(kind=i_def), parameter :: monotone_qm_pos   = 7_i_def
